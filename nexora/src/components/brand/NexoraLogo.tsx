...
export const NexoraLogo: React.FC<NexoraLogoProps> = ({
  ...
  const content = (
    <>
      ...
      <div
        className={cn(
          'relative rounded-full overflow-hidden border border-cyan-500/30 shadow-sm shadow-cyan-500/20 shrink-0 transition-transform duration-200 group-hover:scale-105 select-none bg-gradient-to-br from-indigo-600 via-sky-500 to-cyan-400',
      ...
      >
        {!hasError ? (
          ...
          <svg
            ...
            aria-label="Nexora Logo Fallback"
          >
            <defs>

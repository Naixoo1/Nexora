...
export const TUTOR_MODES: {
  ...
  },
  {
    ...
    description: 'Structured outlines, research questions, and methodology frameworks.',
    icon: Lightbulb,
  ...
  },
  {
    ...
    shortLabel: 'General',
    description: 'Direct, clear, and versatile conversational replies for any question.',
    icon: MessageSquare,
